...
<div class="d-flex justify-content-end align-items-center mb-4">
    <a class="btn" href="{{ route('atk.stock-in.create') }}" style="background: #3B82F6; color: #ffffff; font-weight: 600; padding: 10px 20px; border-radius: 8px; font-family: 'Poppins', sans-serif; display: flex; align-items: center; gap: 8px; box-shadow: 0 4px 6px -1px rgba(59, 130, 246, 0.2); border: none;">
        ...
        <table class="table align-middle mb-0" style="font-family: 'Poppins', sans-serif; font-size: 13.5px; width: 100%;">
            <thead>
                <tr style="background: #F8FAFC; border-bottom: 1px solid var(--border);">
                    <th style="padding: 16px 24px; font-weight: 700; color: #475569; text-transform: uppercase; font-size: 11px; letter-spacing: 0.5px; width: 20%;">Tanggal</th>
                    ...
                    <th style="padding: 16px 24px; font-weight: 700; color: #475569; text-transform: uppercase; font-size: 11px; letter-spacing: 0.5px; width: 15%;">Jumlah</th>
                    ...
                    <th style="padding: 16px 24px; font-weight: 700; color: #475569; text-transform: uppercase; font-size: 11px; letter-spacing: 0.5px; width: 25%;">Catatan</th>
                </tr>
            </thead>
            <tbody style="border-top: none;">
                ...
                <tr style="border-bottom: 1px solid #F1F5F9; transition: background 0.2s ease;" onmouseover="this.style.backgroundColor='#F8FAFC'" onmouseout="this.style.backgroundColor='transparent'">
                    ...
                    <td style="padding: 18px 24px; color: #10B981; font-weight: 600;">
                ...
                <tr>
                    <td colspan="5" style="text-align: center; padding: 64px 24px; color: #94A3B8;">
                        ...
                        <div style="font-weight: 600; font-size: 14px; color: #64748B;">Belum ada riwayat barang masuk</div>
                        <div style="font-size: 12.5px; color: #94A3B8; margin-top: 4px;">Setiap aktivitas restock item ATK akan tercatat di halaman ini.</div>
                    </td>
                </tr>
                @endforelse
            </tbody>
